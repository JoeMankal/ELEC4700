...
Box2_specular = false;					% Set whether the top box is specular or diffuse
...
title('Average Temperature pf System over Time')
xlabel('Time (s)')
...
print('Part3_1','-dpng')													% Save plot as an image to add into report
...
xlabel('Velocity (m/s)')
ylabel('Count')
print('Part3_2','-dpng')													% Save histogram as an image to add into report
...
print('Part3_3','-dpng')													% Save density map as an image to add into report
...
print('Part3_4','-dpng')													% Save temperature map as an image to add into report