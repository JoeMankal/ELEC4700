...
for i = 1:nElectrons
    ...
    electrons(i,3,:) = v_g * randn;
    electrons(i,4,:) = v_g * randn;
    vel_dist(i) = sqrt(electrons(i,3,1)^2 + electrons(i,4,1)^2);
    Temps(i) = (electrons(i,3,1)^2 + electrons(i,4,1)^2)...
        * m_n / (2 * C.kb);
end
...
for i = 2:nSims
    for n = 1:nElectrons
        ...
        if P_scat > rand
            electrons(n,3,:) = v_g * randn;
            electrons(n,4,:) = v_g * randn;
        end
        ...
        elseif electrons(n,1,i-1) <= 0
            ...
            electrons(n,1,i) = electrons(n,1,i-1) + (electrons(n,3,i)...
                * Delta_t);
        end
