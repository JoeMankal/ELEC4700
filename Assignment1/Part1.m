...
MFP = v_g * taugh_mn;               % Mean Free Path calculation

fprintf('The thermal velocity of the electrons is %e m/s and the mean free path is %e m',v_g,MFP)
...
print('Part1','-dpng')														% Save plot as an image to add into report